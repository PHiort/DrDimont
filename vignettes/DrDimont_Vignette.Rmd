...
output: 
    ...
    toc: true 
vignette: >
  %\VignetteIndexEntry{A Pipeline for Drug Response Prediction from Differential Analysis of Multi-omics Networks}
